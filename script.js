...
//       TRANSFORMING DATA
console.log([1000, 2000, 3000].map(s => s * 1.1));
console.log([5, 10, 15, 20].filter(n => n > 10));
console.log([1, 2, 3, 4].reduce((a, b) => a + b));
console.log([1, [2, [3]]].flat(2));
console.log([1, 2, 3].flatMap(x => [x, x * 2]));

//       CHECK CONDITIONS
console.log([20, 25, 30].every(a => a >= 18));
console.log([12, 17, 22].some(a => a < 18));
...
console.log([10, 20, 30].toReversed());

//      CONVERT & ITERATE
console.log(["Jan", "Feb", "Mar"].join(", "));
console.log([...["x", "y", "z"].keys()]);
console.log([...["x", "y", "z"].values()]);
console.log([...["x", "y", "z"].entries()]);
